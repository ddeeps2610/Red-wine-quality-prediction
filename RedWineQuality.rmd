...
qplot(data=wine, x=quality.factor, y=fixed.acidity, geom = 'boxplot') + ylim(4,14)
```
...
qplot(data=wine, quality.factor, residual.sugar, geom='boxplot') + ylim(0.5,4)
```
...
qplot(data=wine, quality.factor, chlorides, geom='boxplot') + ylim(0,.15)
```
...
qplot(data=wine, quality.factor, pH, geom='boxplot') + ylim(2.5,4)
```
...
```{r, echo=FALSE}
qplot(data=wine, quality.factor, sulphates, geom='boxplot') + ylim(0.25, 1.2)
```
...
qplot(data=wine, quality.factor, alcohol, geom='boxplot') + ylim(8,14)
```
